...
function Book({book}) {
    ...
    const isbn_10 = volumeInfo.industryIdentifiers && volumeInfo.industryIdentifiers[0].identifier;
    const isbn_13 = volumeInfo.industryIdentifiers && volumeInfo.industryIdentifiers.length > 1 ? volumeInfo.industryIdentifiers[1].identifier : null;
    const isbn = isbn_13 ? isbn_13 : isbn_10;
    const title = volumeInfo.title;
    const googleCover = volumeInfo 
